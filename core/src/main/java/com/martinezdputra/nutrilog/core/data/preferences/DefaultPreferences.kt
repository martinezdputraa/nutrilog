...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        val genderString = sharedPref.getString(Preferences.KEY_GENDER, null) ?: "male"
        val activityLevelString = sharedPref.getString(Preferences.KEY_ACTIVITY_LEVEL, null) ?: "medium"
        val goalType = sharedPref.getString(Preferences.KEY_GOAL_TYPE, null) ?: "keep_weight"
