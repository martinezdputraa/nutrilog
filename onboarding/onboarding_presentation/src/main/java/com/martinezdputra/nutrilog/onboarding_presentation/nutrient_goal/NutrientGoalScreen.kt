...
fun NutrientGoalScreen(
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                value = viewModel.state.collectAsState().value.carbsRatio,
                onValueChange = {
            ...
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                value = viewModel.state.collectAsState().value.proteinRatio,
                onValueChange = {
            ...
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                value = viewModel.state.collectAsState().value.fatRatio,
                onValueChange = {
